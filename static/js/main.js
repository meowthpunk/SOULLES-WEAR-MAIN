...
main_button.onClick(mainButtonClickedTest)
...
console.log(JSON.parse(JSON.stringify(window.Telegram.WebApp.initData)))
...
function pesik2(){
  exported = {id: exportId, expProduct:productList, cost: cartCost()}
  fetch("/", {
    method: "POST",
